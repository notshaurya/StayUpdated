...
class _SciencepageState extends State<Sciencepage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Science News",style: TextStyle(fontSize: 20, fontFamily: 'ChelseaMarket',fontWeight: FontWeight.bold)),
      ),
...
class MainNews {
  ...
  String url = "https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=3d0174f321ba406daf5daa0f48d5c724";
