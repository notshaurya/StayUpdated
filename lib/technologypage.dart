...
class _TechnologypageState extends State<Technologypage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Technology News",style: TextStyle(fontSize: 20, fontFamily: 'ChelseaMarket',fontWeight: FontWeight.bold)),
      ),
...
class MainNews {
  ...
  String url = "https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=3d0174f321ba406daf5daa0f48d5c724";
